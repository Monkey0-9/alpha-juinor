...
from mini_quant_fund.risk.factor_exposure import FactorExposureEngine
from mini_quant_fund.risk.tail_risk import compute_tail_risk_metrics
from mini_quant_fund.risk.market_impact_models import TransactionCostModel
from mini_quant_fund.risk.sizing import KellySizer
from mini_quant_fund.data.utils.schema import ensure_dataframe
from mini_quant_fund.risk.sector_mapping import SECTOR_MAP
from mini_quant_fund.risk.sector_hedger import SectorHedger
from mini_quant_fund.risk.beta_neutralizer import BetaNeutralizer
from mini_quant_fund.risk.dynamic_stop_loss import DynamicStopLoss

from mini_quant_fund.regime.markov import RegimeModel
from mini_quant_fund.governance.institutional_specification import CVaRConfig
...
class RiskManager:
    ...
    def check_pre_trade(
        ...
        if self.use_cvar_gate and current_cvar > self.cvar_limit:
            ...
            # Use strict scaling from mini_quant_fund.config if available
