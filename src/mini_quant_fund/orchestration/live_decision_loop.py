...
from mini_quant_fund.database.manager import DatabaseManager, get_db
...
from mini_quant_fund.utils.tracing import trace_span
...
class LiveDecisionLoop:
    ...
    def __init__(
        ...
        # Initialize positions from mini_quant_fund.database
    ...
    def _generate_agent_outputs(self, symbol: str, current_price: float, latest_prices: Dict[str, float]) -> List[Dict]:
        ...
        try:
            ...
            # Fetch recent price data from mini_quant_fund.database
