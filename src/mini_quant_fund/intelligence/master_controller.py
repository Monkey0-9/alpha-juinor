...
class MasterIntelligenceController:
    ...
    def _init_components(self):
        ...
        try:
            from mini_quant_fund.intelligence.elite_brain import get_elite_brain
        ...
        try:
            from mini_quant_fund.intelligence.return_predictor import get_return_predictor
    ...
    def generate_master_decision(
        ...
        if self.brain:
            for sym in alpha_signals:
                ...
                # Build model predictions from mini_quant_fund.alpha and predictor
                model_preds = {
