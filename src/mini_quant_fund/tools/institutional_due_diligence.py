...
class InstitutionalDueDiligence:
    ...
    def _load_components(self):
        ...
        try:
            from mini_quant_fund.intelligence import get_ultimate_controller
        ...
        try:
            from mini_quant_fund.risk.stress_testing import get_stress_framework
    ...
    def load_historical_data(
        ...
        """Load historical price data from mini_quant_fund.database."""
        if end_date is None:
