...
try:
    from mini_quant_fund.risk.engine import RiskDecision, RiskCheckResult, RiskManager
except ImportError:
    RiskDecision = None
...
try:
    from mini_quant_fund.data.provider import YahooDataProvider  # type: ignore
except Exception:
...
class BacktestEngine:
    ...
    def _accrue_interest(self, timestamp: datetime):
        ...
        if self.portfolio.cash > 0:
            ...
            from mini_quant_fund.portfolio.ledger import PortfolioEvent, EventType
