...
class AutonomousTradingBrain:
    ...
    def _init_all_modules(self):
        ...
        # Regime Analyzer
        try:
            from mini_quant_fund.analytics.regime_analyzer import get_regime_analyzer
        ...
        try:
            from mini_quant_fund.strategies.strategy_universe import get_strategy_universe
        ...
        try:
            from mini_quant_fund.strategies.institutional_strategies import get_institutional_hub
        ...
        try:
            from mini_quant_fund.strategies.aggressive_recovery import get_hrhr_engine
        ...
        # Dip Buyer
        try:
            from mini_quant_fund.strategies.dip_buyer import get_dip_buyer
        ...
        # Smart Money
        try:
            from mini_quant_fund.intelligence.smart_money_detector import get_smart_money_detector
