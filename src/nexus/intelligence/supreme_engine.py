...
class SupremeDecisionEngine:
    ...
    def _init_all_modules(self):
        ...
        # Strategy Selector
        try:
            from mini_quant_fund.intelligence.strategy_selector import get_strategy_selector
        ...
        # Precision Analyzer
        try:
            from mini_quant_fund.analytics.precision_analyzer import get_precision_analyzer
        ...
        # Master Orchestra
        try:
            from mini_quant_fund.intelligence.master_orchestrator import get_master_brain
