...
from mini_quant_fund.audit.decision_log import write_audit
...
from mini_quant_fund.data_intelligence.data_state_machine import get_data_state_machine
...
from mini_quant_fund.regime.controller import get_regime_controller
from mini_quant_fund.risk.engine import RiskManager
from mini_quant_fund.services.risk_enforcer import RiskEnforcer
from mini_quant_fund.strategies.filters import InstitutionalFilters
from mini_quant_fund.strategies.ml_referee import MLReferee
from mini_quant_fund.strategies.nlp_engine import InstitutionalNLPEngine
from mini_quant_fund.strategies.regime_engine import RegimeEngine
...
class InstitutionalStrategy:
    ...
    def train_models(self, train_panel):
        ...
        if train_panel is not None and not train_panel.empty:
            logger.info(f"[STRATEGY] Training model on {len(train_panel)} bars")
