...
class ConfigManager:
    ...
    def __new__(cls, config_path: Optional[str] = None):
        if cls._instance is None:
            ...
            # Resolve path automatically if not provided
            if config_path is None:
                candidates = [
                    os.getenv("GOLDEN_CONFIG_PATH"),
                    "configs/golden_config.yaml",
                    "../configs/golden_config.yaml",
                    os.path.join(os.path.dirname(__file__), "golden_config.yaml")
                ]
                ...
                if config_path is None:
                    config_path = "configs/golden_config.yaml" # Default fallback
    ...
    def _inject_secrets(self):
        ...
        from mini_quant_fund.utils.secrets_vault import vault
