...
from mini_quant_fund.risk.cvar_gate import get_cvar_gate
from mini_quant_fund.risk.cvar_gate import get_cvar_gate
from mini_quant_fund.regime.controller import get_regime_controller
from mini_quant_fund.execution.algo_executor import get_smart_execution, AlgoType
...
class InstitutionalAllocator:
    ...
    def _allocate_legacy(self, signals, prices, volumes, current_portfolio=None, ts=None, metadata=None, method="risk_parity"):
        """
