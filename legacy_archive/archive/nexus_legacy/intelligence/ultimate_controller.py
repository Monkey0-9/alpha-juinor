...
class UltimateAIController:
    ...
    def _init_all_components(self):
        ...
        try:
            from mini_quant_fund.intelligence.multi_agent_ensemble import get_multi_agent_ensemble
        ...
        # Strategic Reasoner
        try:
            from mini_quant_fund.intelligence.strategic_reasoner import get_strategic_reasoner
        ...
        # Neural Predictor
        try:
            from mini_quant_fund.intelligence.neural_predictor import get_neural_predictor
        ...
        # Alpha Generator
        try:
            from mini_quant_fund.intelligence.alpha_generator import get_alpha_generator
        ...
        # Regime Detector
        try:
            from mini_quant_fund.intelligence.regime_detector import get_regime_detector
        ...
        # Risk Manager
        try:
            from mini_quant_fund.intelligence.risk_manager import get_adaptive_risk_manager
        ...
        # Portfolio Optimizer
        try:
            from mini_quant_fund.intelligence.portfolio_optimizer import get_portfolio_optimizer
