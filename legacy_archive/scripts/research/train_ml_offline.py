...
def train_model():
    ...
    # 3. Train/Test logic with temporal cutoff to avoid look-ahead bias
    # Use a fixed date split instead of random split on concatenated data
    ...
    logger.info(f"Samples: Train={len(X_train)}, Test={len(X_test)}")
