...
try:
    ...
    from mini_quant_fund.backtest.execution import RealisticExecutionHandler, Order, OrderType
    from mini_quant_fund.risk.engine import RiskManager
    from mini_quant_fund.strategies.ml_models.ml_alpha import MLAlpha
    from mini_quant_fund.data.processors.features import FeatureEngineer
    from mini_quant_fund.reports.performance_attribution import PerformanceAnalyzer
except ImportError as e:
    logger.error(f"Failed to import mini_quant_fund.core modules: {e}")
    sys.exit(1)
