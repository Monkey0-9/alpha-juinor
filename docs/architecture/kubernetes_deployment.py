...
class CloudNativeDeploymentManager:
    ...
    def _load_services_config(self) -> Dict[str, ServiceConfig]:
        ...
        services_file = self.config_dir / "mini_quant_fund.services.yaml"
    ...
    def generate_kubernetes_manifests(self) -> Dict[str, str]:
        ...
        manifests["mini_quant_fund.monitoring.yaml"] = self._generate_monitoring_manifests()
    ...
    def _generate_configmaps_manifest(self) -> str:
        ...
        app_config = {
            ...
            "data": {
                "mini_quant_fund.config.yaml": yaml.dump({
    ...
    def _generate_monitoring_manifests(self) -> str:
        ...
        service_monitor = {
            "apiVersion": "mini_quant_fund.monitoring.coreos.com/v1",
            "kind": "ServiceMonitor",
            "metadata": {
