...
from core.monitoring.infrastructure_guard import get_infra_guard
from market_structure.micro_analyzer import get_micro_analyzer
...
async def verify_reality():
    ...
    await cloud._simulate_kubectl_apply("deployment.yaml")
