...
class TestMonteCarloMeanReversionStrategy(unittest.TestCase):
    ...
    def test_strategy_name(self):
        ...
        self.assertEqual(self.strategy.name, "MC_MeanReversion_Elite")
    ...
    def test_insufficient_data(self):
        ...
        self.assertEqual(signal.metadata["error"], "Insufficient data")
    ...
    def test_metadata_contains_fair_value(self):
        ...
        self.assertIn("fv_low", signal.metadata)
        self.assertIn("fv_high", signal.metadata)
        self.assertIn("fair_value_range", signal.metadata)
