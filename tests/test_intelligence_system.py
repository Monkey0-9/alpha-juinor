...
try:
    from mini_quant_fund.ml_alpha.advanced_intelligence_engine import get_intelligence_system
    controller = get_intelligence_system()
...
if controller is None:
    print("  ⚠ Skipping - Intelligence Engine not available")
    signals = []
else:
...
try:
    from mini_quant_fund.intelligence import get_adaptive_risk_manager
...
try:
    from mini_quant_fund.intelligence import get_regime_detector
