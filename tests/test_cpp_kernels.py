...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), "..", "nexus", "cpp_extensions")))

# Test indicators
from nexus.math.indicators import compute_hurst_exponent, HawkesProcess  # noqa: E402
